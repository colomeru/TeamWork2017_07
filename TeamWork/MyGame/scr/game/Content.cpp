...
void Content::LoadSprite(Sprite& sprite, Model& model)
{
	...
	sprite.Load("bowHanger.png", SPRITE_ID::BOWHANGER_SPRITE);
	sprite.Load("bowHangerCode.png", SPRITE_ID::BOWHANGER_CODE_SPRITE);
...
void Content::LoadFont(FontManager& font)
{
	...
	font.AddFont(FONT_ID::NAME_FONT, "HGRGY.TTC", "HG行書体", 80);
}
